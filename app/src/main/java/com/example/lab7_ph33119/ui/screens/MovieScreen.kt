package com.example.lab7_ph33119.ui.screens
    ...
    Card(
        ...
        Column(
            ...
            Column(
                ...
                BoldValueText(
                    label = "Thời lượng: ", value = movie.duration.toString()
                )
                BoldValueText(
    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                BoldValueText(label = "Thể loại: ", value = "Tình cảm")
                Text(
